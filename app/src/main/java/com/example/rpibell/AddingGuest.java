...
/**
 * This is the Adding Guest Class which will allow for an admin user to make a guest account.
 */
public class AddingGuest extends AppCompatActivity {
    ...
    public FirebaseAuth mAuth;                              // access to Firebase Authentication
    public FirebaseFirestore db;                            // access to Firebase Firestore
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // get all info from the past Activity
    ...
    public void registerNewUser() {
        ...
        mAuth.createUserWithEmailAndPassword(guestEmailString, guestPasswordString).addOnCompleteListener(this, task -> {
            if (task.isSuccessful()) {  // Sign in success
                ...
                profile.put("adminID",adminUID);
                profile.put("email", guestEmailString);
                profile.put("hostname", hostname);
                profile.put("name", name);
                profile.put("password",guestPasswordString);
                ...
                db.collection("guests")
                        ...
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                // sign out of the newly created guest account
